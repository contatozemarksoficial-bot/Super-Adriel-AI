...
def main():
    ...
    with col1:
        ...
        clique_varrer = st.button("🚀 INICIAR VARREDURA REAL", key="btn_v_2026_final")
    with col2:
    ...
    if clique_varrer:
        ...
        st.info("Painel operacional. Utilize o menu lateral esquerdo para navegar nos módulos.")
