...
def main():
    ...
    # FORCADOR ULTRA LUXO CYBER-NEON BLINDADO V8 (IMUNE AO BUG DO PYTHON 3.14)
    estilo_luxo = "<style>"
    ...
    # FORMATADOR DOS GRÁFICOS ESCUROS NATIVOS (ELIMINA FUNDO BRANCO DA CANVAS)
    ...
    if "how to" in termo_limpo or "lose" in termo_limpo or "cure" in termo_limpo or "fast" in termo_limpo or "ways to" in termo_limpo or "treatment" in termo_limpo:
        ...
        txt_estrategia = "ESTRATÉGIA DO ROBÓ AFILIADO ELITE: Intencao de descoberta! O lead possui uma dor (quer emagrecer ou tratar um sintoma) mas nao conhece nenhuma solucao comercial. Nao mande para a Pre-Sell de afiliado! Use paginas de captura (Nurturing), entregue uma isca digital gringa ou capture o e-mail para vender na sequencia."
    ...
    with c_desenho_dir:
        ...
        # Desenho estrutural geométrico feito 100% em blocos de info nativos imunes a bugs de parser
    ...
    df_g2 = pd.DataFrame({"Dias": lista_dias, "Visitas": [v := x for x in lista_c2]}) # Proteção linear
