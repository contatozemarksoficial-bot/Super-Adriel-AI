...
def main():
    ...
    if produto_nome:
        ...
        # =============================================================================================================
        # 6. EXCLUSIVIDADE ABSOLUTA: 45 PALAVRAS-CHAVE DIFERENTES DE FUNDO DE FUNIL CONTENDO O NOME DO PRODUTO
        # =============================================================================================================
        ...
        with c_colchete:
            ...
            # 🪐 AMARRAÇÃO INLINE DEFINITIVA: Construtor fechado em linha compacta sem falhas de parser e sem cortes do chat
